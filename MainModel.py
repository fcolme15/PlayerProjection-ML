...
def main():
    ...
    exitString = "exit"
    print("Enter the name of the NFL WR you want stats on: \n(To exit type 'exit')")
    newName = input("Name: ")
    newNameLower = newName.lower()
    while newNameLower != exitString:
        newPlayer(newName)
        print("Enter the name of the NFL WR you want stats on: \n(To exit type 'exit')")
        newName = input("Name: ")
        newNameLower = newName.lower()
...
def newPlayer(player):
    ...
    stats2024 = stats2024[stats2024['player_display_name'].str.lower() ==  player.lower()]
    ...
    player_data = combined_stats[combined_stats['player_display_name'].str.lower() == player.lower()]
    player_new_stats = stats2024[stats2024['player_display_name'].str.lower() == player.lower()]
